    ...
    <>
      ...
      <footer className="bg-seekon-deepNavy text-seekon-platinumSilver">
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              >
                ...
                <span className="text-lg text-seekon-platinumSilver">Apparel</span>
              </Link>
              
              <p className="text-seekon-platinumSilver text-sm leading-relaxed mb-6 max-w-xs">
                Premium sneakers and apparel for the modern lifestyle. Discover the latest trends and timeless classics from top brands.
              </p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 pt-8 border-t border-seekon-charcoalGray"
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mb-4 md:mb-0">
              <motion.a
                ...
                className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center text-white hover:text-cyan-400 hover:bg-cyan-500 transition-all duration-200"
              >
            ...
            <div className="text-center md:text-right">
              <p className="text-seekon-platinumSilver text-sm">
                © 2025 Seekon Apparel. All rights reserved.
              </p>
              <div className="flex space-x-4 mt-2 text-xs text-seekon-platinumSilver">
                <Link
                  to="/privacy"
